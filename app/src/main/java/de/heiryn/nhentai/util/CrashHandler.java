...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
	...
	public static String CRASH_DIR = FilesUtil.PATH_SD + "/NHBooks/Logs/";
	public static String CRASH_LOG = CRASH_DIR + "CrashLog_%s.log";
	...
	public void uncaughtException(Thread thread, Throwable throwable) {
		File f = new File(String.format(CRASH_LOG, System.currentTimeMillis()));
		if (f.exists()) {
			f.delete();
		} else {
			try {
