...
public abstract class TwoWaySpinner extends TwoWayAdapterView<SpinnerAdapter> {
	...
	public TwoWaySpinner(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TwoWaySpinner(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		initAbsSpinner();
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public TwoWaySpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        a.recycle();
	...
	void recycleAllViews() {
		...
		final TwoWaySpinner.RecycleBin recycleBin = mRecycler;
	...
	static class SavedState extends View.BaseSavedState {
		...
		/**
		 * Constructor called from {@link TwoWayAdapterView#onSaveInstanceState()}
		 */
