package de.heiryn.nhentai.ui.widget
...
class SwipeBackCoordinatorLayout : CoordinatorLayout {
	...
	companion object {
		...
		fun getBackgroundColor(percent: Float): Int {
			return Color.argb((255 * (0.9 - percent * (0.9 - 0.5))).toInt(), 0, 0, 0)
		}
		 ...
		 */
		fun hideBackgroundShadow(background: View) {
